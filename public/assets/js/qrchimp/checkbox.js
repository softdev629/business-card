...
{    var component = event.target;
  ...
  if (event.target.getAttribute('data-type') == "qrc_page_wrapper") {
    ...
    if (chimpData[pIndex].value.header.cardEnabled == "block") {
      chimpData[pIndex].value.header.cardEnabled = "none";

    } else {
      chimpData[pIndex].value.header.cardEnabled = "block";
    }
